...
public class Trail : MonoBehaviour
{
    ...
    public bool emittingDone = false;
    ...
    private float innerDeadTimer = 0;
    ...
    void Start()
    {
        ...
        //trailObj.transform.parent = gameObject.transform;
        ...
        //props.Add("innerDeadTimer", 0);
        //props.Add("atEnd", new AtEndDelegate(Kill));
        //Ani.Mate.Stop(this);
        //Ani.Mate.To(this, lifeTime, props);

        StartCoroutine(Animate.Lerp(0.0f, lifeTime, (v, ev) => { if (ev == Animate.Event.End) Kill(); }, Animate.Linear));
    }
    ...
    void Update()
    {
        ...
        if (emit)
        {
            ...
            if (add)
            {
                ...
                {
                    var p = new Point[points.Length + 50];
